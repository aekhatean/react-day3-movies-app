...
const topMovies = axios.create({
  baseURL: `https://api.themoviedb.org/3/discover/movie?api_key=${REACT_APP_API_KEY_MOVIE_DB_V3}&include_adult=false&include_video=false&with_watch_monetization_types=flatrate`,
});
